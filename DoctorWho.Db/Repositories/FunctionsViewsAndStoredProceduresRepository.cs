...
namespace DoctorWho.Db
{
    ...
    {
        public void Ex_Companions_Function(int EpisodeId)
        {
        ...
        public void Ex_spSummariseEpisodes()
        {
            using var context = new DoctorWhoDbContext();
